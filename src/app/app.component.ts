...
export class MyApp {
  ...
  pages: any[] = [ //Tableau d'élement, les items de notre menu
    ...
    { icon: 'log-out', title: 'Logout', component: 'LoginPage' }
      ...
      //platform = savoir quel platform utiliser ^ config= ^ splashScreen= image de chargement
  constructor(public userProvider: UserProvider, private translate: TranslateService, platform: Platform, private config: Config, private statusBar: StatusBar, private splashScreen: SplashScreen) {
    platform.ready().then(() => {
      ...
      this.statusBar.styleDefault(); // StatusBar prendre la valeur par défault(Page de chargement au lancement)
